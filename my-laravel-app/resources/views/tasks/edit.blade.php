        ...
        <div class="md:w-1/2 mx-auto">
            <div class="col col-md-offset-3 col-md-6">
                <nav class="panel panel-default bg-white shadow rounded-lg">
                    <div class="panel-heading bg-gray-200 p-4 rounded-t-lg">タスクを編集する</div>
                    <div class="panel-body p-4">
                        ...
                        <form action="{{ route('tasks.edit', ['folder' => $task->folder_id, 'task' => $task->id]) }}" method="POST">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <select name="status" id="status" class="text-gray-500 border border-gray-500 text-black rounded py-2 w-full mt-2">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="text-gray-500 border border-gray-500 text-black rounded py-2 w-full mt-2" name="due_date" id="due_date" value="{{ old('due_date') ?? $task->formatted_due_date }}" />
                            </div>
